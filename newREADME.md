...
> [!NOTE] You can achieve different results with the addition of holding Ctrl or Shift, but they're all variations of these 3 controls.
...
Plans include improved tolerance handling for complex arc sequences, global coverage beyond Australia, optional terrain intersection modelling, colour‑coded visualisation based on airspace class and an altitude slicing “cross‑section” mode.

### License

This project is provided without a license in this repository. Consult the repository owner for licensing terms.